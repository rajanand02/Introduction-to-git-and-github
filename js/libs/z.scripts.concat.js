...
(function($) {
  ...
  slideMe2.add(TweenMax.to($('#slide-me .step2'),0.2,{opacity:0,rotationX:90, transformOrigin:"50% bottom", perspective:1000}));
  slideMe2.add(TweenMax.from($('#slide-me .step3'),1,{opacity:0,rotationX:90, transformOrigin:"50% bottom", perspective:1000,ease:Elastic.easeOut}));

  var slideMe3 = new TimelineMax();
  slideMe3.add(TweenMax.to($('#slide-me .step3'),0.2,{opacity:0,rotationX:90, transformOrigin:"50% bottom", perspective:1000}));
  slideMe3.add(TweenMax.from($('#slide-me .step4'),1,{opacity:0,rotationX:90, transformOrigin:"50% bottom", perspective:1000,ease:Elastic.easeOut}));

  var slideMe4 = new TimelineMax();
  slideMe4.add(TweenMax.to($('#slide-me .step4'),0.25,{rotation:720,fontSize:'2px',opacity:0,ease:Expo.easeIn}));
  slideMe4.add(TweenMax.from($('#slide-me .step5'),0.25,{rotation:-720,fontSize:'2px',opacity:0,ease:Expo.easeOut}));
