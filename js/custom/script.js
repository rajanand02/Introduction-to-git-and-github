...
(function($) {
  ...
  var slideWhyNew = new TimelineMax();
  // outro prev slide
  slideWhyNew.add(TweenMax.to($('#octocat'),0.25,{left:-300, ease:Expo.easeIn}),0);
  slideWhyNew.add(TweenMax.to($('#slide-github .step1'),0.25,{left:'100%', ease:Expo.easeIn}),0);
  slideWhyNew.add(TweenMax.to($('#slide-github .step2'),0.25,{left:'100%', ease:Expo.easeIn}),0);
  slideWhyNew.add(TweenMax.to($('#slide-github .step3'),0.25,{left:'100%', ease:Expo.easeIn}),0);
  slideWhyNew.add(TweenMax.to($('#slide-github'),0,{immediateRender:false,css:{display:'none'}}));

  // set initial state
  $('#slide-whyNew .step').css({position:'absolute',top:125});
  $('#slide-whyNew .step5').css({position:'absolute',top:240});

  // intro
  slideWhyNew.add(TweenMax.to($('#slide-whyNew'),0,{immediateRender:false,css:{display:'block'}}));
  slideWhyNew.add(TweenMax.to($('body'),0.5,{backgroundColor:'#fff2d0'}));
  slideWhyNew.add(TweenMax.fromTo($('#slide-whyNew .step1'),0.5,{top:240},{top:120}),0);
  slideWhyNew.add(TweenMax.fromTo($('#slide-whyNew .step1 h1'),0.5,{fontSize:'0px'},{fontSize:'160px'}),0);

  var slideWhy1New = new TimelineMax();
  slideWhy1New.add(TweenMax.to($('#slide-whyNew .step1 h1'),0.25,{fontSize:'120px'}));
  slideWhy1New.add(TweenMax.to($('#slide-whyNew .step1'),0.25,{top:30}),0);
  slideWhy1New.add(TweenMax.from($('#slide-whyNew .step2'),0.5,{opacity:0}));
  slideWhy1New.add(TweenMax.from($('#slide-whyNew .step2 .step-a'),0.5,{right:-400,ease:Bounce.easeOut}),0);
  slideWhy1New.add(TweenMax.from($('#slide-whyNew .step2 .img-left'),0.5,{rotationY:-720, transformOrigin:"50% 50%", perspective:2000, ease:Expo.easeOut}),0);

  var slideWhy2New = new TimelineMax();
  slideWhy2New.add(TweenMax.to($('#slide-whyNew .step2'),0.25,{opacity:0}));
  slideWhy2New.add(TweenMax.to($('#slide-whyNew .step2 .img-left'),0.5,{rotationY:720, transformOrigin:"50% 50%", perspective:2000, ease:Expo.easeInOut}),0);
  slideWhy2New.add(TweenMax.from($('#slide-whyNew .step3 .img-left'),0.5,{rotationY:-720, transformOrigin:"50% 50%", perspective:2000, ease:Expo.easeInOut}),0);
  slideWhy2New.add(TweenMax.from($('#slide-whyNew .step3 .step-a'),0.5,{right:-400,ease:Bounce.easeOut}),0);
  slideWhy2New.add(TweenMax.from($('#slide-whyNew .step3'),0.5,{opacity:0}),0);

  var slideWhy3New = new TimelineMax();
  slideWhy3New.add(TweenMax.to($('#slide-whyNew .step3'),0.25,{opacity:0}));
  slideWhy3New.add(TweenMax.to($('#slide-whyNew .step3 .img-left'),0.5,{rotationY:720, transformOrigin:"50% 50%", perspective:2000, ease:Expo.easeInOut}),0);
  slideWhy3New.add(TweenMax.from($('#slide-whyNew .step4 .img-left'),0.5,{rotationY:-720, transformOrigin:"50% 50%", perspective:2000, ease:Expo.easeInOut}),0);
  slideWhy3New.add(TweenMax.from($('#slide-whyNew .step4 .step-a'),0.5,{right:-400,ease:Bounce.easeOut}),0);
  slideWhy3New.add(TweenMax.from($('#slide-whyNew .step4'),0.5,{opacity:0}),0);

  var slideWhy4New = new TimelineMax();
  slideWhy4New.add(TweenMax.to($('#slide-whyNew .step4'),0.25,{opacity:0}));
  slideWhy4New.add(TweenMax.from($('#slide-whyNew .step5'),0.5,{opacity:0,left:-400,ease:Expo.easeOut}));
